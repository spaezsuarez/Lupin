...
public class Tablero extends JPanel implements SujetoObservable{
    ...
    public Tablero(EnemigoController[] perrosControllers,LlaveController[] llavesJuego,EnemigoController guardianController,TesoroController tesoro,LupinController lupinController) {
